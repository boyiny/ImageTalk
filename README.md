...
This repository contains the code and example workflows for **ImageTalk**, a multimodal text-generation system designed to support people living with Motor Neuron Disease (plwMND) in augmentative and alternative communication (AAC) contexts.
